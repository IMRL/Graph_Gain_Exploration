...
public:
    ...
    //
    FeatureDesc UpdateFrame(const cv::Mat1b &frame, int frameIndex);
    void Compare(FeatureDesc &frame, int *matchIndex = nullptr, float *matchDis = nullptr, int *matchBias = nullptr);
    //
