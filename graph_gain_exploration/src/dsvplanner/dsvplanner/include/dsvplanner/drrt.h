...
{
public:
  Drrt(ChunkMap::Ptr chunk_map, DualStateGraph* graph, DualStateFrontier* frontier,
       OccupancyGrid* grid);
  ~Drrt();
  ...
  StateVec root_;
  StateVec twist_;
  tf::StampedTransform preTransformToMap;
  tf::StampedTransform transformToMap;
  std::vector<pcl::Vertices> pclPolygons;
  pcl::PointCloud<pcl::PointXYZ>::Ptr scanConcavePoint_ = 
      pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>());
  std::vector<pcl::Vertices> scanPolygons;
  std::vector<double> scanPolar;
  std::vector<double> preScanPolar;
  std::vector<double> diffPolar;
  std::vector<double> samplePolar;
  std::discrete_distribution<> discreteProb;
//   std::vector<double> probIntegration;
  std::vector<tf::Vector3> polygons;
  pcl::PointCloud<pcl::PointXYZ>::Ptr scanPolarPoint_ = 
      pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>());
  pcl::PointCloud<pcl::PointXYZ>::Ptr scanCloud_  =
      pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>());
  pcl::PointCloud<pcl::PointXYZI>::Ptr poseCov_ = 
      pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>());
  std::vector <geometry_msgs::Point> loopPoint, tspTour;
  bool loopflag;
  bool loopInit;
  bool loopContinue;
  ...
  void plannerInit();
  void plannerInit_szz();
  void plannerIterate();
  void pruneTree(StateVec root);
  void publishNode();
  void publishTSPPath();
  void publishPlanningHorizon();
  void publishPose(StateVec twist_);
  void publishConcaveHull();
  ...
  double graphGain_concave(StateVec state);
  void outputFile();
  void updateGraphGain();
  void getConcaveHull();
...
protected:
  ...
  pcl::PointCloud<pcl::PointXYZI>::Ptr sampledPoint_ =
      pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>());
  pcl::PointCloud<pcl::PointXYZI>::Ptr concavePoint_ = 
      pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>());
  pcl::PointCloud<pcl::PointXYZI>::Ptr obstaclePoint_ = 
      pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>());
//   pcl::PointCloud<pcl::PointXYZI>::Ptr concaveHull_ = 
//       pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>());
